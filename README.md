...
- Tried to implement a Binpackage that included a reference of cities to use in the code.
- Use of similarity scores referencing a cities in an attached CSV, Textfile, and Excel.
